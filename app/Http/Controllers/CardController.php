...
{
    public function store(Request $request, Board $board, CreateCardAction $action)
    {
    ...
    public function update(Request $request, Card $card, UpdateCardAction $action)
    {
    ...
    public function move(Request $request, Card $card, MoveCardAction $action)
    {
        $this->authorize('update', $card);
    ...
    public function destroy(Card $card, DeleteCardAction $action)
    {
